...
class AtividadeController{
    async list(req: Request, res: Response){
        ...
        const lista = await repository.createQueryBuilder('tb_atividades').innerJoinAndSelect("tb_atividades.diariogeral", "diariogeral").getMany(); //encontra tudo o que está no repositório do atividade/models
